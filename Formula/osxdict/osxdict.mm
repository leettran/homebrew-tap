...
// Distributed under The Unlicensed.
...
void usage(ostream& out, char* pathname) {
  ...
  out << "example use: " << name << " [-a | -A | -d name [-d name] ... ] [-j] <term> ..." << endl;
  out << "alternative: " << name << " -l [-A]" << endl;
  out << endl;
  out << "available options:" << endl;
  out << "    -h, --help               print this help information" << endl;
  out << "    -d, --dictionary <name>  look up term in dictionary <name>" << endl;
  out << "    -a, --active             look up term in active dictionary" << endl;
  out << "    -A, --all                look up term in all dictionaries" << endl;
  out << "    -j, --json               output json format" << endl;
  out << "    -l, --list               list dictionaries" << endl;
  out << "    -l -A                    list all available dictionaries" << endl;
  out << endl;
  out << "environment variables:" << endl;
  out << "    OSX_DICTIONARY        colon-separated list of dictionaries" << endl;
  out << "                          can also specify ALL or ACTIVE" << endl;
  out << "                          default if no dictionary in command" << endl;
}
...
int osxdict(int argc, char* argv[]) {
